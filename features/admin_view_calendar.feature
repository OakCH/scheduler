...
Background:
  ...
  | Jane Doe    | 17-Mar-2012 | 23-Mar-2012 | 1   |
  | John Doe    | 1-Apr-2012  | 8-Apr-2012  | 0   |
  | Jane Doe    | 4-Apr-2012  | 12-Apr-2012 | 0   |
  | J.P. Morgan | 17-Feb-2012 | 24-Feb-2012 | 0   |
  | K.D. Tang   | 17-Feb-2012 | 24-Feb-2012 | 0   |
...
Scenario: Viewing calendar by Day Time shift
  ...
  And I should see the vacation belonging to "Jane Doe" from "17-Mar-2012" to "23-Mar-2012"
  And I should see "PTO"
  
Scenario: Changing month with two possible nurses per month
  When I follow "April"
  Then I should see "Jane Doe"
  Then I should see the vacation belonging to "Jane Doe" from "4-Apr-2012" to "12-Apr-2012"
  But I should not see "John Doe"
  And I should not see the vacation belonging to "John Doe" from "1-Apr-2012" to "8-Apr-2012"
...
Scenario: Viewing other units, shifts, and month
  ...
  And I press "Filter calendars"
  When I follow "February"
  Then I should not see "J.P. Morgan"
  And I should see "K.D. Tang"
  And I should see the vacation belonging to "K.D. Tang" from "17-Feb-2012" to "24-Feb-2012"
  And I should not see "PTO"
